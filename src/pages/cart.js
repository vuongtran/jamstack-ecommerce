      ...
      <div className="flex flex-col items-center pb-10">
        ...
        >
          <div className="pt-10 pb-8">
            <h1 className="text-5xl font-light">Giỏ hàng</h1>
          </div>

          {cartEmpty ? (
            <h3>Giỏ hàng đang trống, chọn mua thêm bạn nhé.</h3>
          ) : (
                    ...
                    <div className="border-b py-10" key={item.id}>
                      ...
                      <div className="flex items-center hidden md:flex">
                        ...
                        <div className="flex flex-1 justify-end">
                          <p className="m-0 pl-10  tracking-tighter">
                        ...
                        <div
                          ...
                          className="
                            m-0 ml-10 text-s cursor-pointer
                            "
                        >
                          <FaTimes />
                        </div>
          ...
          <div className="flex flex-1 justify-end py-8">
            <p className="text-sm pr-10">Tổng tiền</p>
